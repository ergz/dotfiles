...
// vec4 TRAIL_COLOR =vec4(1.0, 0.45, 0.0, 1.0);   // bright orange
// vec4 TRAIL_COLOR =vec4(0.0, 1.0, 0.4, 1.0);  // neon green
vec4 TRAIL_COLOR =vec4(0.8, 0.3, 1.0, 1.0); // electric purple
// vec4 TRAIL_COLOR =vec4(1.0, 0.2, 0.7, 1.0);    // hot pink
// vec4 TRAIL_COLOR =vec4(0.2, 0.6, 1.0, 1.0);    // bright cyan-blue (your original)
                                               //
const float DURATION = 0.1; // total animation time
